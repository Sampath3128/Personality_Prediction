...
def code(test_case,file_path):
    ...
    for user in users_list:
        ...
        f.write("\nTEST CASE-"+test_case+" data of "+keywords[0]+" collected is:\n")
        ...
        f.write("URL from which subjects data extracted is: https://www.twiiter.com/"+user_id+"\n")
        
        
        for i in range(len(tweets_translated)):
            f.write(tweets_translated[i]+"\n")
        ...
        if(hate_tweets_percent > 15):
            f1.write("Individual hates others mostly and the percentage of hating tweets is "+str(hate_tweets_percent)+".\n")
        else:
            f1.write("Individual doesn't hates others mostly and the percentage of hating tweets is "+str(hate_tweets_percent)+".\n")
        ...
        if(sexism_tweets_percent > 5):
            f1.write("Individual promotes sexism and has a percentage of tweets related to it is "+str(sexism_tweets_percent)+".\n")
        else:
            f1.write("Individual doesn't promotes sexism and has a percentage of tweets related to it is "+str(sexism_tweets_percent)+".\n")
        ...
        if(bullying_tweets_percent > 1):
            f1.write("The individual has more bullying personality against others and the percentage of bullying tweets is "+str(bullying_tweets_percent)+".\n")
        else:
            f1.write("The individual has less bullying personality against others and the percentage of bullying tweets is "+str(bullying_tweets_percent)+".\n")
        ...
        if(attack_percent >= 0.1):
            f1.write("Individual seems to attack others mostly and the percentage of attacking tweets is "+str(attack_percent)+".\n")
        else:
            f1.write("Individual doesn't seems to attack others mostly and the percentage of attacking tweets is "+str(attack_percent)+".\n")
